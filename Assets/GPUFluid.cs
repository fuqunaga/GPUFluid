...
public class GPUFluid : MonoBehaviour
{
    ...
    public float _velocityToUV;
    public float _viscocity;
    public int _diffuseIteration = 100;
    public int _pressureSolverIteration = 100;
    ...
    private void Start()
    {
        ...
        _debugTex = new RenderTexture(_velocity.descriptor);
        _debugTex.Create();

    }

    public RenderTexture _debugTex;

    private void Update()
    {
        _cs.SetFloat(CSPARAM.DELTA_TIME, Time.deltaTime);
    ...
    public Color _addColor = Color.red;
    public bool _addColorHueAnim = true;
    public Vector2 _addPos;
    public Vector2 _addForceVelocity;
    public float _addRadius = 0.1f;
